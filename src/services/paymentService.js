...
const createPayment = async (driverId, newPayment, data) => {
  try {
    const listIds = data.ids;
    console.log('createPayment', listIds);
    ...
    newPayment.paymentDate = data.paymentDate;
    newPayment.transaction = data.paymentTransaction;
    newPayment.uidUser = data.user;
